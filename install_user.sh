...
# Uncomment to set the keymap you want. Replace "pl" by your country code
...
if [ ! -d "$DOTFILES" ]; then
    # Don't forget to replace klozamarek with your own username on Github
    git clone https://github.com/klozamarek/dotfiles.git \
    "$DOTFILES" >/dev/null
fi
