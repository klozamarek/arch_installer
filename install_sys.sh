...
# Fetch script install_chroot.sh from Github account
curl https://raw.githubusercontent.com/klozamarek/arch_installer/master/install_chroot.sh > /mnt/install_chroot.sh
